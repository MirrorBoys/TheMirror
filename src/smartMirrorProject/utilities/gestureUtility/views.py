            ...
            if results.multi_hand_landmarks is not None:
                for handLandmarks in results.multi_hand_landmarks:
                    ...
                    for point in handsModule.HandLandmark:
                        ...
                        #     drawingModule._normalized_to_pixel_coordinates(
                        ...
                        if point == 8:
                            ...
                            thumb_tip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.THUMB_TIP
                            ].y
                            index_tip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_TIP
                            ].y
                            middle_tip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.MIDDLE_FINGER_TIP
                            ].y
                            ring_tip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.RING_FINGER_TIP
                            ].y
                            pinky_tip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.PINKY_TIP
                            ].y

                            # Extract Y-coordinates for DIP/IP of the fingers
                            thumb_ip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.THUMB_IP
                            ].y
                            index_dip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_DIP
                            ].y
                            middle_dip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.MIDDLE_FINGER_DIP
                            ].y
                            ring_dip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.RING_FINGER_DIP
                            ].y
                            pinky_dip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.PINKY_DIP
                            ].y

                            # Extract Y-coordinates for PIP/MCP of the fingers
                            thumb_mcp_y = handLandmarks.landmark[
                                handsModule.HandLandmark.THUMB_MCP
                            ].y
                            index_pip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_PIP
                            ].y
                            middle_pip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.MIDDLE_FINGER_PIP
                            ].y
                            ring_pip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.RING_FINGER_PIP
                            ].y
                            pinky_pip_y = handLandmarks.landmark[
                                handsModule.HandLandmark.PINKY_PIP
                            ].y

                            # Extract Y-coordinates for MCP/CMC of the fingers
                            thumb_cmc_y = handLandmarks.landmark[
                                handsModule.HandLandmark.THUMB_CMC
                            ].y
                            index_mcp_y = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_MCP
                            ].y
                            middle_mcp_y = handLandmarks.landmark[
                                handsModule.HandLandmark.MIDDLE_FINGER_MCP
                            ].y
                            ring_mcp_y = handLandmarks.landmark[
                                handsModule.HandLandmark.RING_FINGER_MCP
                            ].y
                            pinky_mcp_y = handLandmarks.landmark[
                                handsModule.HandLandmark.PINKY_MCP
                            ].y

                            index_tip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_TIP
                            ].x
                            index_dip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_DIP
                            ].x
                            index_pip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_PIP
                            ].x
                            index_mcp_x = handLandmarks.landmark[
                                handsModule.HandLandmark.INDEX_FINGER_MCP
                            ].x

                            middle_tip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.MIDDLE_FINGER_TIP
                            ].x
                            middle_dip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.MIDDLE_FINGER_DIP
                            ].x
                            middle_pip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.MIDDLE_FINGER_PIP
                            ].x

                            ring_tip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.RING_FINGER_TIP
                            ].x
                            ring_dip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.RING_FINGER_DIP
                            ].x
                            ring_pip_x = handLandmarks.landmark[
                                handsModule.HandLandmark.RING_FINGER_PIP
                            ].x

                            # Check if the fingers are up
                            is_thumb_up = (
                                thumb_tip_y < thumb_cmc_y and thumb_tip_y < thumb_ip_y
                            )
                            is_index_up = (
                                index_tip_y < index_mcp_y and index_tip_y < index_dip_y
                            )
                            is_middle_up = (
                                middle_tip_y < middle_mcp_y
                                and middle_tip_y < middle_dip_y
                            )
                            is_ring_up = (
                                ring_tip_y < ring_mcp_y and ring_tip_y < ring_dip_y
                            )
                            is_pinky_up = (
                                pinky_tip_y < pinky_mcp_y and pinky_tip_y < pinky_dip_y
                            )

                            is_index_pointing_left = (
                                index_tip_x > index_dip_x
                                and index_dip_x > index_pip_x
                                and index_tip_x > middle_tip_x
                                and index_tip_x > middle_dip_x
                                and index_dip_x > middle_tip_x
                                and index_dip_x > middle_dip_x
                                and index_tip_x > ring_tip_x
                                and index_tip_x > ring_dip_x
                                and index_dip_x > ring_tip_x
                                and index_dip_x > ring_dip_x
                            )

                            # Check if other fingers are down
                            are_middle_ring_pinky_down = (
                                middle_tip_y > middle_mcp_y
                                and ring_tip_y > ring_mcp_y
                            ...
                            is_my_thumb_up = (
                                ...
                                and thumb_tip_y < index_dip_y
                                and thumb_tip_y < index_pip_y
                                and thumb_tip_y < index_tip_y
                                and thumb_ip_y < index_mcp_y
                                and thumb_ip_y < index_dip_y
                                and thumb_ip_y < index_pip_y
                                and thumb_ip_y < index_tip_y
                                and thumb_tip_y < middle_mcp_y
                                and thumb_tip_y < middle_dip_y
                                and thumb_tip_y < middle_pip_y
                                and thumb_tip_y < middle_tip_y
                                and thumb_ip_y < middle_mcp_y
                                and thumb_ip_y < middle_dip_y
                                and thumb_ip_y < middle_pip_y
                                and thumb_ip_y < middle_tip_y
                                and thumb_tip_y < ring_mcp_y
                                and thumb_tip_y < ring_dip_y
                                and thumb_tip_y < ring_pip_y
                                and thumb_tip_y < ring_tip_y
                                and thumb_ip_y < ring_mcp_y
                                and thumb_ip_y < ring_dip_y
                                and thumb_ip_y < ring_pip_y
                                and thumb_ip_y < ring_tip_y
                                and thumb_tip_y < pinky_mcp_y
                                and thumb_tip_y < pinky_dip_y
                                and thumb_tip_y < pinky_pip_y
                                and thumb_tip_y < pinky_tip_y
                                and thumb_ip_y < pinky_mcp_y
                                and thumb_ip_y < pinky_dip_y
                                and thumb_ip_y < pinky_pip_y
                                and thumb_ip_y < pinky_tip_y
                            )

                            is_my_pinky_up = (
                                pinky_tip_y < index_mcp_y
                                and pinky_tip_y < index_dip_y
                                and pinky_tip_y < index_pip_y
                                and pinky_tip_y < index_tip_y
                                and pinky_dip_y < index_mcp_y
                                and pinky_dip_y < index_dip_y
                                and pinky_dip_y < index_pip_y
                                and pinky_dip_y < index_tip_y
                                and pinky_tip_y < middle_mcp_y
                                and pinky_tip_y < middle_dip_y
                                and pinky_tip_y < middle_pip_y
                                and pinky_tip_y < middle_tip_y
                                and pinky_dip_y < middle_mcp_y
                                and pinky_dip_y < middle_dip_y
                                and pinky_dip_y < middle_pip_y
                                and pinky_dip_y < middle_tip_y
                                and pinky_tip_y < ring_mcp_y
                                and pinky_tip_y < ring_dip_y
                                and pinky_tip_y < ring_pip_y
                                and pinky_tip_y < ring_tip_y
                                and pinky_dip_y < ring_mcp_y
                                and pinky_dip_y < ring_dip_y
                                and pinky_dip_y < ring_pip_y
                                and pinky_dip_y < ring_tip_y
                            )
